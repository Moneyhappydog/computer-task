...
## 更新
- [2025/09/25] (1)报纸和笔记类型的图片提升到200DPI,修复了1.0版本的OCR和table的gt；(2)为了平衡中英文页面数量，并提升包含公式页面的数量，新增了374个页面，其中中文增加了25个页面，英文增加了349个页面，包括书籍类、PPT类、彩色图文教材类、试卷、杂志和报纸类，行间公式数量从353个增加到1050个；公式增加了语种属性，行间的中文公式数量增至68个，英文公式数量增至982个；
