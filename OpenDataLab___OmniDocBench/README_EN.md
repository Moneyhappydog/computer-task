...
English [简体中文](https://opendatalab.com/OpenDataLab/OmniDocBench/blob/main/README.md)
...
## Updates
- [2025/09/25] (1)Images of newspaper and notes have been increased to 200 DPI. Fixed some issues with OCR and table GT in version 1.0.(2)To balance the number of pages in Chinese and English and increase the number of pages containing formulas, 374 new pages have been added, including 25 in Chinese and 349 in English. These pages include books, PPTs, colorful textbooks, test papers, magazines, and newspapers. The number of inline formulas has increased from 353 to 1050. Language attributes have been added to formulas, increasing the number of Chinese formulas to 68 and English formulas to 982.
